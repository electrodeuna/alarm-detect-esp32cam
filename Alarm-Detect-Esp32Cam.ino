...
const char* ssid     = "NOMBRE-WIFI";      //Define your own SSID
const char* password = "PASSWORD";   // Define your own password
...
// control ends
 ...
 WiFi.config(IPAddress(192, 168, 0, 72), IPAddress(192, 168, 43, 2), IPAddress(255, 255, 255, 0));
